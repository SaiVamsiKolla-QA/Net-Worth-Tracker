 ...
 */
export const formatCurrency = (amount: number): string => new Intl.NumberFormat(CURRENCY_FORMAT.locale, {
    style: 'currency',
 ...
 */
export const formatCompactCurrency = (amount: number): string => new Intl.NumberFormat(CURRENCY_FORMAT.locale, {
    style: 'currency',
    currency: CURRENCY_FORMAT.currency,
    notation: 'compact',
 ...
 */
export const formatDate = (date: Date): string => new Intl.DateTimeFormat(CURRENCY_FORMAT.locale, DATE_FORMAT.short).format(date);

/**
 * Format date in long format
 * Example: new Date('2024-01-15') → "January 15, 2024"
 */
export const formatDateLong = (date: Date): string => new Intl.DateTimeFormat(CURRENCY_FORMAT.locale, DATE_FORMAT.long).format(date);

/**
 * Format large numbers with commas
 * Example: 1234567 → "1,234,567"
 */
export const formatNumber = (num: number): string => new Intl.NumberFormat(CURRENCY_FORMAT.locale).format(num);
